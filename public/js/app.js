...
/* harmony import */ var apollo_link_ws__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! apollo-link-ws */ "./node_modules/apollo-link-ws/lib/bundle.esm.js");
...
/* harmony import */ var _pages_App__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/App */ "./resources/js/pages/App.vue");
...
var link = (0,apollo_link__WEBPACK_IMPORTED_MODULE_4__.split)(function (_ref) {
  var query = _ref.query;
  var definition = (0,apollo_utilities__WEBPACK_IMPORTED_MODULE_5__.getMainDefinition)(query);
  return definition.kind === 'OperationDefinition' && definition.operation === 'subscription';
}, wsLink, httpLink);
var cache = new apollo_cache_inmemory__WEBPACK_IMPORTED_MODULE_6__.InMemoryCache();
var apolloClient = new apollo_client__WEBPACK_IMPORTED_MODULE_7__.ApolloClient({
  link: link,
  cache: cache,
  connectToDevTools: true
});
vue__WEBPACK_IMPORTED_MODULE_8__.default.use(vue_apollo__WEBPACK_IMPORTED_MODULE_0__.default);
...
new vue__WEBPACK_IMPORTED_MODULE_8__.default({
  ...
  render: function render(h) {
    return h(_pages_App__WEBPACK_IMPORTED_MODULE_1__.default);
  }
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/graphql-tag/node_modules/tslib/tslib.es6.js");
...
var eventemitter3_1 = __webpack_require__(/*! eventemitter3 */ "./node_modules/subscriptions-transport-ws/node_modules/eventemitter3/index.js");
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "ApolloMutation": () => (/* binding */ ApolloMutation),
/* harmony export */   "ApolloProvider": () => (/* binding */ ApolloProvider$1),
/* harmony export */   "ApolloQuery": () => (/* binding */ ApolloQuery),
/* harmony export */   "ApolloSubscribeToMore": () => (/* binding */ ApolloSubscribeToMore),
      ...
      return _objectSpread2(_objectSpread2({
        query: function query() {
          if (typeof this.query === 'function') {
            return this.query(graphql_tag__WEBPACK_IMPORTED_MODULE_0__.default);
          }
  ...
  methods: {
    ...
    refresh: function refresh() {
      ...
      if (typeof document === 'function') {
        document = document(graphql_tag__WEBPACK_IMPORTED_MODULE_0__.default);
      }
  ...
  methods: {
    mutate: function mutate(options) {
      ...
      if (typeof mutation === 'function') {
        mutation = mutation(graphql_tag__WEBPACK_IMPORTED_MODULE_0__.default);
      }
...
var render = function() {
  ...
  return _c("div", [
    _c("h1", { staticClass: "text-lg font-bold mb-4" }, [_vm._v("Messages")]),
    _vm._v(" "),
    _c(
      "ul",
